			...
			<p class="w3-leftbar w3-xlarge w3-white  w3-cqsfont" style="margin-left: 200px;"><a><?php echo "{$adminDetails['name']} | {$session_name} - {$FacultyName}"; ?></a></p>
				...
				<div class="w3-col l3 m3 s12 w3-padding w3-card-4 w3-margin-left" style=" margin-top: 1%; margin-bottom: 1%;">
					...
					<form class="w3-form w3-padding" action="<?php echo "{$absPath}StreamController/stream_addfacultycourse.php"; ?>" method="post">
						...
						<label>Department</label><select class="w3-input w3-border-blue" name="department" id="department" required="required">
						
							<?php

								echo $DepartmentOptionList;
							?>
						</select><br/>
						...
						<p class="w3-center"> <button class="w3-btn w3-green" type="submit" id="btnAddCourse">Add</button> </p>
