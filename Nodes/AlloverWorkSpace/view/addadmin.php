	...
	<?php include_once('menu_inclusion.php'); ?>
		...
		<div class="w3-container w3-white" style="margin-left: 0%; margin-right: 0%; margin-top: 59px; min-height: 520px; height: auto;">
			...
			<p class="w3-leftbar w3-xlarge w3-white  w3-cqsfont" style="margin-left: 200px;"><a><?php echo $adminDetails['name']; ?></a></p>
				...
				<p class="w3-cqsfont w3-large" style="margin-left:  200px;">Add Admin to <?php echo $FacultyName; ?> <a  class="w3-tag w3-small w3-padding w3-red" onclick="window.close()"><I class="fa fa-times"></I>&nbsp;Close Registration</a></p>
				...
				<div class="w3-col l6 m6 s12" style="margin-left: 200px; margin-top: 1%; margin-bottom: 1%; height: auto; display: flex; justify-content: center;">
					...
					<div class="w3-col l12 m12 s12">
						...
						<form class="w3-form w3-padding" action="<?php echo "{$absPath}StreamController/stream_addadmin.php"; ?>" method="post">
							...
							<p class="w3-center"> <button class="w3-btn w3-green" type="submit" id="btnAddAdmin">Add</button> </p>
