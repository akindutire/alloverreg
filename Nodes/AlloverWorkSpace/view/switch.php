		...
		<div class="w3-container w3-white" style="margin-left: 0%; margin-right: 0%; margin-top: 59px; min-height: 520px; height: auto;">
				...
				<div class="w3-col l6 m6 s12" style="margin-left: 200px; margin-top: 1%; margin-bottom: 1%; height: auto; display: flex; justify-content: center;">
					...
					<div class="w3-col l12 m12 s12">
						...
						<form class="w3-form w3-padding" action="<?php echo "{$absPath}StreamController/stream_switchstudent.php"; ?>" method="post">
							...
							<label>New Level</label><select name="level" class="w3-input">
							...
							<label>New Semester</label><select name="semester" class="w3-input">
							...
							<p class="w3-center"> <button class="w3-btn w3-green" type="submit" id="">Switch</button> </p>
