<?php
	...
	if(!empty($faculty) && !empty($department) && !empty($priority) && !empty($fname) && !empty($mname) && !empty($lname) && !empty($username) && !empty($password)){
		...
		$adminActivity->create_account_for_dept($cleansedSet[1],$cleansedSet[2],$cleansedSet[3],$cleansedSet[4],$cleansedSet[5],$priority,$cleansedSet[0],$department);
